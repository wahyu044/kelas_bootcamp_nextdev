...
st.write("3. Problem Identification")
st.write("4. Exploratory Data Analysis")
st.write("5. Pre-processing")
st.write("6. Modeling")
st.write("7. Demo App")
...
st.write("6. education --> Edukasi terakhir")
st.write("7. urban --> Area tempat tinggal")
st.write("8. gender ")
...
st.markdown("<p style='text-align: justify; color: white;'>Berdasarkan dataset yang dimuat, kami ingin melakukan proses EDA dan Modelling untuk memecahkan permasalahan, yaitu:</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>1. Melakukan klasifikasi karakter responden yang mengalami gejala depresi dan gangguan kecemasan berdasarkan respon yang diberikan.</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>2. Membandingkan akurasi dari algoritma Decision Tree, K-Nearest Neighbors, dan Multinomial Naive Bayes</p>", unsafe_allow_html=True)
...
st.markdown("<p style='text-align: justify; color: white;'>Level of Response</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>1. (1 = Did not apply to me at all)</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>2. (2 = Applied to me to some degree, or some of the time)</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>3. (3 = Applied to me to a considerable degree, or a good part of the time)</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>4. (4 = Applied to me very much, or most of the time)</p>", unsafe_allow_html=True)
...
sns.despine()
st.pyplot(fig_dep)
st.markdown("<p style='text-align: justify; color: white;'>Dari hasil visualisasi pada label depression dapat diketahui bahwa response pada level 2 (Applied to me to some degree, or some of the time) lebih dominan namun persebaran datanya cukup merata.</p>", unsafe_allow_html=True)
...
sns.despine()
st.pyplot(fig_str)
st.markdown("<p style='text-align: justify; color: white;'>Dari hasil visualisasi pada label stress dapat diketahui bahwa response pada level 2 (Applied to me to some degree, or some of the time) lebih dominan namun persebaran datanya cukup merata.</p>", unsafe_allow_html=True)
...
sns.despine()
st.pyplot(fig_anx)
st.markdown("<p style='text-align: justify; color: white;'>Dari hasil visualisasi pada label anxiety dapat diketahui bahwa response pada level 1 (Did not apply to me at all) lebih dominan namun persebaran datanya cukup merata.</p>", unsafe_allow_html=True)
...
##Pre-Processing
st.write("## Modeling")
st.markdown("<p style='text-align: justify; color: white;'>Melakukan klasifikasi dengan tiga metode yang disebutkan sebelumnya, yaitu Decision Tree, K-Nearest Neighbor dan Multinomial Naive Bayes.</p>", unsafe_allow_html=True)
...
st.markdown("<p style='text-align: justify; color: white;'>Berikut hasil akurasi dari proses klasifikasi yang dilakukan pada masing-masing kategori.</p>", unsafe_allow_html=True)
...
# evaluasi
st.write(classification_report(y_dep_test, y_pred))
...
##Demo
st.write("## Demo App")
st.markdown("<p style='text-align: justify; color: white;'>Pada bagian ini kita dapat mengisi survey dan memperoleh hasil prediksi terhadap level depresi, stres dan kecemasan yang kita miliki. Dalam mengisi survey ini terdapat tiga jenis pertanyaan yaitu sebagai berikut.</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>1. Question of Depression, Stress and Anxiety</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>2. Question of Personality</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: justify; color: white;'>3. Question of Subjects</p>", unsafe_allow_html=True)
...
clf_dep.fit(X_dep, y_dep)
clf_str.fit(X_str, y_str)
clf_anx.fit(X_anx, y_anx)
